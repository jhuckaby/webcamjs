...
var Webcam = {
	...
	parsed: function(image_data_uri) {
		...
		return {
			format: image_fmt,
			blob: new Blob( [ this.base64DecToArr(raw_image_data) ], {type: 'image/'+image_fmt} )
		};
	},
	...
	upload: function(image_data_uri, target_url, callback) {
		...
		var parsed = this.parsed(image_data_uri);
		form.append( form_elem_name, parsed.blob, form_elem_name+"."+parsed.format.replace(/e/, '') );
